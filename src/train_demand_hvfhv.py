...
def main():
    ...
    raw = pd.read_parquet(PROCESSED_DIR / "hvfhv_hourly_demand.parquet")
    ...
    model_path = OUTPUTS_DIR / "hvfhv_demand_model.joblib"
    ...
    results_path = OUTPUTS_DIR / "hvfhv_demand_predictions.parquet"
